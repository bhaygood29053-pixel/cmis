...
def build_historical_comparison_evidence(
    ...
    *,
    ...
    """Build a non-promotional evidence record from one deterministic comparison.

    Data quality is intentionally local to this isolated fact comparison. Even
    HIGH quality does not establish archive depth, retention, finality
    equivalence, or broader provider correctness.
    """
