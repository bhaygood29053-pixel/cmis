...
from .fortiblox_route_inventory import (
    DEFAULT_CAPTURE_DWELL_SECONDS as FORTIBLOX_ROUTE_INVENTORY_DEFAULT_CAPTURE_DWELL_SECONDS,
    DEFAULT_MAX_CAPTURE_PAGES as FORTIBLOX_ROUTE_INVENTORY_DEFAULT_MAX_CAPTURE_PAGES,
    DEFAULT_MAX_DISCOVERED_ROUTES as FORTIBLOX_ROUTE_INVENTORY_DEFAULT_MAX_DISCOVERED_ROUTES,
    DEFAULT_MAX_NETWORK_EVENTS_PER_PAGE as FORTIBLOX_ROUTE_INVENTORY_DEFAULT_MAX_NETWORK_EVENTS_PER_PAGE,
    DEFAULT_ROUTE_DISCOVERY_DWELL_SECONDS as FORTIBLOX_ROUTE_INVENTORY_DEFAULT_ROUTE_DISCOVERY_DWELL_SECONDS,
    ROUTE_INVENTORY_CONTRACT as FORTIBLOX_ROUTE_INVENTORY_CONTRACT,
