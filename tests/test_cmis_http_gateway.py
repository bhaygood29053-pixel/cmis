...
class CMISHTTPGatewayTests(unittest.TestCase):
    ...
    def test_capabilities_expose_versioned_chain_contract(self):
        ...
        self.assertEqual(x1["instant_x1_scan"]["state"], "bounded")
        self.assertTrue(x1["instant_x1_scan"]["callable"])
        self.assertTrue(x1["instant_x1_scan"]["public_service_promoted"])
        self.assertTrue(x1["instant_x1_scan"]["scout_reliance_promoted"])
        self.assertFalse(x1["instant_x1_scan"]["execution_authorized"])
        ...
        self.assertEqual(solana["instant_x1_scan"]["state"], "unavailable")
        self.assertFalse(solana["instant_x1_scan"]["callable"])
    ...
    def test_capabilities_require_bearer_auth_when_configured(self):
        ...
        self.assertEqual(response["contract_version"], "1.19.0")
