...
- **XONE/XNT Conversion Intelligence: PRIMARY TRACK IS NOW LEAD-DRIVEN / WAITING FOR A PRIMARY XONE ALLOCATION ARTIFACT.** The accepted chain now extends through #622 / PR #623 `xone_xnt_primary_allocation_artifact_resolution/v1`, after #619 / PR #620 completed bounded public allocation-source provenance with 0 qualifying XONE sources. Resolver run #3 passed deterministic and operational gates at head `21be1b27f10ffd1be4ab5d91ec6b1554b60f64c9`; Liquidity Scout Tests #1838 passed; PR #623 merged as `e288ed4bf4620654f64b57615a963efbe64e7700`. The accepted operational state is intentionally `NO_LEAD`: zero direct network-client imports, `network_discovery_performed=false`, `network_request_count=0`, no handoffs, and `execution_authorized=false`. CMIS can now ingest one already-retrieved exact registry/export/API/Merkle/IPFS/Arweave/X1-program lead, verify locator/hash/XONE-binding prerequisites, classify it as REJECTED/CANDIDATE/RESOLVED_FOR_HANDOFF, and route only a reproducible exact-XONE artifact to the correct stronger verifier. An initial test exposed that immutable IPFS/Arweave content addressing was pinned but not counted as complete locator provenance; that narrow defect was fixed and regression-tested before acceptance. No actual XONE primary allocation artifact has yet been supplied or resolved. Broad current-web/archive/repository discovery remains paused; snapshot→XNT allocation binding, issuance, vesting/unlock, October 6 applicability, cross-chain correlation, public/Scout promotion, and execution remain unverified/unauthorized.
