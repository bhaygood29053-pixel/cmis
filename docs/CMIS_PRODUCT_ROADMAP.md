...
- **XONE/XNT Conversion Intelligence: PRIMARY TRACK REMAINS THE ETHEREUM XONE SNAPSHOT / REGISTRY; BOUNDED X1-SIDE ALLOCATION-RECORD DISCOVERY IS NOW COMPLETE.** #575 / PR #578 established dedicated discovery; #580 / PR #581 exact Ethereum XONE identity; #583 / PR #584 canonical XONE events; #586 / PR #587 burn/redeemer semantics; #589 / PR #590 exact Ethereum candidate discovery; #592 / PR #593 X1 XNT rule/account discovery; #595 / PR #596 exact X1 binding discovery; #604 / PR #605 `ethereum_xone_snapshot_registry/v1`; #607 / PR #608 `xone_snapshot_provenance_expansion/v1`; #610 / PR #611 `xone_snapshot_archival_source_recovery/v1`; #613 / PR #614 `xone_snapshot_archived_asset_graph_resolution/v1`; and #616 / PR #617 `xone_xnt_x1_allocation_record_discovery/v1`. Accepted allocation-record run #7 covered all 3 bounded repositories, 15 ranked repository files, and all 3 official X1 targets and produced 0 qualifying records / 0 candidates / 0 exact XONE-identity-bound candidates / 0 XNT-amount candidates. Earlier run #4 exposed 12 ABI/bytecode false positives from `FairCrypto/x1-app/public/abi/XONE.json`; those were rejected before acceptance and converted into deterministic regressions. The accepted zero is scoped public-source evidence only and does not prove a private/unpublished allocation registry does not exist. CMIS remains ready to reconstruct the XONE holder ledger once an authoritative snapshot block is identified. The next evidence class is narrower allocation-source provenance: exact registry/export/API/Merkle/program-account artifacts or newly supplied/publicly discovered primary evidence, followed only then by snapshot→allocation binding and XONE-specific issuance/vesting/unlock proof. MoonParty remains historical background, not current priority. No public-service/Scout promotion or execution authority is implied.
