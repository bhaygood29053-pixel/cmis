...
- **Large-Trade → #498 live handoff: ACTIVE / NOT YET ACCEPTED.** Protected `cmis-core` PR #41 has green deterministic private-core CI, but the dedicated live handoff workflow is still in progress. The exact live PASS remains the acceptance gate; deterministic CI is not a substitute.
