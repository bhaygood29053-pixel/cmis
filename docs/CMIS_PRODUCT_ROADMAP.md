...
- **XONE/XNT Conversion Intelligence: PRIMARY TRACK REMAINS THE ETHEREUM XONE SNAPSHOT / REGISTRY.** #575 / PR #578 established dedicated discovery; #580 / PR #581 exact Ethereum XONE identity; #583 / PR #584 canonical XONE events; #586 / PR #587 burn/redeemer semantics; #589 / PR #590 exact Ethereum candidate discovery; #592 / PR #593 X1 XNT rule/account discovery; #595 / PR #596 exact X1 binding discovery; #604 / PR #605 `ethereum_xone_snapshot_registry/v1`; #607 / PR #608 `xone_snapshot_provenance_expansion/v1`. Provenance Expansion run #6 covered both FairCrypto repos, x1-labs/xenblocks-airdrop, 4 official X1 targets, 13 available X1 Report pages and 1 available indexed Jack-history surface. After rejecting ordinary XONE ABI/config false positives, it produced 0 provenance candidates / 0 artifact candidates / 0 authoritative exact snapshot blocks. That is scoped public-provenance evidence only and does not prove a private/unpublished snapshot does not exist. CMIS remains ready to reconstruct every XONE balance from creation through an authoritative snapshot block and require two-RPC registry-digest agreement. The next gate is deeper primary-source/archival snapshot recovery, then explicit snapshot→XNT allocation binding and XONE-specific XNT issuance/vesting/unlock proof. MoonParty remains historical background, not current priority. No public-service/Scout promotion or execution authority is implied.
