...
- **XONE/XNT Conversion Intelligence: ACCEPTED INTERNAL FOUNDATION through bounded MoonParty deployment discovery.** #575 / PR #578 established dedicated web discovery; #580 / PR #581 exact Ethereum XONE identity; #583 / PR #584 bounded canonical event observation; #586 / PR #587 burn/redeemer semantics; #589 / PR #590 exact-address Ethereum candidate discovery; #592 / PR #593 X1 XNT rule/account discovery; #595 / PR #596 exact X1 binding discovery; #598 / PR #599 authoritative FairCrypto MoonParty source semantics; #601 / PR #602 `moonparty_deployment_verification/v1`. The accepted MoonParty design still directly links XONE participation/redemption with XNT-credit accounting, but deployment is not yet identified. Deployment Verification run #2 retrieved 4/4 pinned FairCrypto sources, 6/6 current frontend targets and 26/28 same-host JS chunks across 35 inspected documents, yielding 0 exact deployment-address candidates. That is scoped corpus evidence only, not proof of non-deployment. MoonParty deployment identity/runtime/XONE binding, native-XNT equivalence, XNT issuance/vesting, XONE snapshot eligibility, October 6 applicability, and Ethereum→X1 correlation remain unverified. Next gate is provenance-expanded deployment-address discovery followed by the already-built runtime/XONE/two-RPC qualification contract. No public-service/Scout promotion or execution authority is implied.
