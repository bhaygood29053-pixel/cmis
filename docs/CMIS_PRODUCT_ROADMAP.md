...
- **XONE/XNT Conversion Intelligence: PRIMARY TRACK REMAINS THE ETHEREUM XONE SNAPSHOT / REGISTRY.** #575 / PR #578 established dedicated discovery; #580 / PR #581 exact Ethereum XONE identity; #583 / PR #584 canonical XONE events; #586 / PR #587 burn/redeemer semantics; #589 / PR #590 exact Ethereum candidate discovery; #592 / PR #593 X1 XNT rule/account discovery; #595 / PR #596 exact X1 binding discovery; #604 / PR #605 `ethereum_xone_snapshot_registry/v1`; #607 / PR #608 `xone_snapshot_provenance_expansion/v1`; #610 / PR #611 `xone_snapshot_archival_source_recovery/v1`. Archival Recovery run #4 had 9/9 CDX queries available, discovered 93 historical captures and successfully replayed 11 diversified captures across the bounded archive pass. It recovered 0 stable primary URLs / 0 archival provenance candidates / 0 authoritative exact snapshot blocks. TwStalker HTTP 403 and transient Wayback replay failures remain availability evidence, not proof of absent content. CMIS remains ready to reconstruct every XONE balance from creation through an authoritative snapshot block and require two-RPC registry-digest agreement. The next gate is archived asset-graph / primary-source resolution over historical XEN/X1 scripts, manifests, JSON/static assets and X/X Spaces identifiers, followed by explicit snapshot→XNT allocation binding and XONE-specific XNT issuance/vesting/unlock proof. MoonParty remains historical background, not current priority. No public-service/Scout promotion or execution authority is implied.
