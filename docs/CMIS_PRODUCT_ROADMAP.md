...
- **XONE/XNT Conversion Intelligence: ACCEPTED INTERNAL FOUNDATION through authoritative FairCrypto MoonParty source semantics.** #575 / PR #578 established dedicated web discovery; #580 / PR #581 exact Ethereum XONE identity; #583 / PR #584 bounded canonical event observation; #586 / PR #587 burn/redeemer semantics; #589 / PR #590 exact-address Ethereum candidate discovery; #592 / PR #593 X1 XNT rule/account discovery; #595 / PR #596 exact X1 binding discovery; #598 / PR #599 `xone_xnt_moonparty_source_semantics/v1`. The latest pinned-source proof directly verifies that FairCrypto's MoonParty design combines XONE participation/redemption with burn/redeemer semantics and per-user/aggregate XNT-credit allocation accounting (`allocateXNTCredits` / `totalAllocatedXNTCredits`). This is the strongest mechanism evidence yet, but it is source-level only: MoonParty deployment address/chain/runtime, XNT-credit-to-native-XNT equivalence, XNT issuance/vesting, XONE snapshot eligibility, October 6 applicability, and Ethereum→X1 correlation remain unverified. Next gate is exact MoonParty deployment identification plus runtime and `XONE()` binding verification. No public-service/Scout promotion or execution authority is implied.
