...
3. **X1.Ninja follow-on semantics: PARALLEL / NOT THE DEFAULT NEXT BLOCKER.** The original developer-API transport/identity program has produced accepted downstream foundations; remaining open semantic/research issues should advance only when they close a current product gap.
