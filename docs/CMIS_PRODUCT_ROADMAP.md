...
- **XONE/XNT Conversion Intelligence: PRIMARY TRACK REMAINS THE ETHEREUM XONE SNAPSHOT / REGISTRY, NOW ADVANCING TO X1-SIDE ALLOCATION RECORDS.** #575 / PR #578 established dedicated discovery; #580 / PR #581 exact Ethereum XONE identity; #583 / PR #584 canonical XONE events; #586 / PR #587 burn/redeemer semantics; #589 / PR #590 exact Ethereum candidate discovery; #592 / PR #593 X1 XNT rule/account discovery; #595 / PR #596 exact X1 binding discovery; #604 / PR #605 `ethereum_xone_snapshot_registry/v1`; #607 / PR #608 `xone_snapshot_provenance_expansion/v1`; #610 / PR #611 `xone_snapshot_archival_source_recovery/v1`; #613 / PR #614 `xone_snapshot_archived_asset_graph_resolution/v1`. Asset Graph run #4 discovered 41 root captures, replayed 6 roots, extracted 237 asset edges including 136 same-origin traversable edges, retrieved 4 archived application assets, and found 0 semantic snapshot candidates / 0 stable primary social URLs / 0 content-addressed pointers / 0 authoritative exact snapshot blocks. That is scoped public archived-asset evidence only and does not prove a private/unpublished/unpreserved snapshot does not exist. CMIS remains ready to reconstruct every XONE balance from creation through an authoritative snapshot block and require two-RPC registry-digest agreement. The next gate is X1-side XONE→XNT allocation-record discovery keyed by Ethereum addresses, followed by explicit snapshot→allocation binding and XONE-specific issuance/vesting/unlock proof. MoonParty remains historical background, not current priority. No public-service/Scout promotion or execution authority is implied.
