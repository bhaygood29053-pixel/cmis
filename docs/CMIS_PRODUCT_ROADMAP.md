...
9. **X1 Intelligence Brief runtime promotion (#637): BLOCKED ON PROTECTED ACTIONS #52.** The #635/PR #636 foundation is accepted. Next, protected runtime must internally build the subject×service matrix and only then may CMIS expose `x1_intelligence_brief_inputs/v1` to X1 Scout. No caller-supplied component facts, no whole-X1 coverage claim, and no promotion before executable protected CI passes.
