...
- **XONE/XNT Conversion Intelligence: ACCEPTED INTERNAL FOUNDATION via #575 / PR #578; exact Ethereum XONE identity via #580 / PR #581; bounded Ethereum XONE event observer via #583 / PR #584.** `ethereum_xone_identity/v1` verifies Ethereum mainnet XONE as `0x4DCDa2274899d9BbA3Bb6f5A852C107Dd6E4fE1c`. `ethereum_xone_event_observer/v1` now verifies canonical XONE mint/transfer/burn events in bounded block windows. Live run #1 corroborated the creation-block mint of exactly 500,000,000 XONE from the zero address to deployer `0xc73fc08c931efe3fce850c09278472e8a81c2e05` in the creation transaction. This does not prove lifetime supply, a migration sink, conversion ratio, eligibility, XNT issuance/vesting, or Ethereum→X1 correlation. Next gate is exact lock/migration/conversion sink semantics. No public-service/Scout promotion or execution authority is implied.
