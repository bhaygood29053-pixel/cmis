...
- **XONE/XNT Conversion Intelligence: ACCEPTED INTERNAL FOUNDATION through conversion-candidate discovery.** #575 / PR #578 established dedicated web discovery; #580 / PR #581 exact Ethereum XONE identity; #583 / PR #584 bounded canonical event observation; #586 / PR #587 burn/redeemer semantics; #589 / PR #590 `xone_xnt_conversion_candidate_discovery/v1`. Candidate Discovery run #2 inspected 13 ranked X1 Report pages and produced 0 XONE/XNT candidate claims / 0 exact Ethereum address candidates. That is scoped corpus evidence only and does not prove no converter exists. XONE's burn-accounting/redeemer model remains verified, but exact XONE→XNT candidate-role binding, conversion ratio/eligibility, X1 XNT issuance/vesting/claim semantics, and Ethereum→X1 correlation remain unverified. Next gate is independent X1-side XNT migration/distribution/vesting/claim mechanism discovery and verification. No public-service/Scout promotion or execution authority is implied.
