...
- **XONE/XNT Conversion Intelligence: ACCEPTED INTERNAL FOUNDATION through independent X1-side XNT mechanism discovery.** #575 / PR #578 established dedicated web discovery; #580 / PR #581 exact Ethereum XONE identity; #583 / PR #584 bounded canonical event observation; #586 / PR #587 burn/redeemer semantics; #589 / PR #590 exact-address Ethereum candidate discovery; #592 / PR #593 `x1_xnt_distribution_mechanism_discovery/v1`. The latest live gate parsed 17 bounded claims from the official X1 incentivized-testnet-rewards page and verified the current source wording around 50,000 credits = 1 XNT, 10%/90%, and 365-day lock/vesting/unlock mechanics as source claims. The page contained 0 exact 32-byte X1 pubkey candidates, which is scoped page evidence only. This cleanly separates known validator-reward rules from the still-unproven XONE→XNT mechanism. Exact XONE→XNT account/program role binding, XNT issuance provenance, XONE-specific vesting/claim semantics, and Ethereum→X1 correlation remain unverified. Next gate is exact X1 account/program binding discovery from primary X1/XONE sources plus bounded direct X1 history. No public-service/Scout promotion or execution authority is implied.
